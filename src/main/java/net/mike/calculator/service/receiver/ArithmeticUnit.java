...
//receiver
		public class ArithmeticUnit {
				  ...
				  converter = this.new Converter();
				    sp = this.new Spliter();
				      operandsList = sp.getOperands(exp);
				        ...
				        //Делаем проверку операндов выражения - если Римские, то переводим в арабские   
				          ...
				          /* делаем проверку операндов, что они <= 10*/
				          		if (operand1.intValue() > 10 || operand2.intValue() > 10) throw 
				          		    new IllegalArgumentException("Калькулятор проводит операции с числами <= 10");
				
				            		  result = op.apply(operand1, operand2);
				            		    int r2;
				            		      r2 =  result.intValue();//нужно Number перевести в int
			...
			public enum Operations {
			    ...
			    DIVIDE("/") {
			        @Override
			        public Number apply(Number x, Number y) {   //нужно вернуть double 
